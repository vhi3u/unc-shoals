...
if LES
    params_base = (; Lx=200e3, Ly=200e3, Lz=50)
else
    params_base = (; Lx=100000, Ly=200000, Lz=50)
end
if arch == CPU()
    params_base = (; params_base..., Nx=60, Ny=60, Nz=10)
else
    params_base = (; params_base..., Nx=400, Ny=400, Nz=50)
end
