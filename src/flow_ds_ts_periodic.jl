...
# sponge functions
@inline sponge_u(x, y, z, t, u, p) = -(south_mask(x, y, z, p)) * u / p.τ
@inline sponge_v(x, y, z, t, v, p) = -(south_mask(x, y, z, p)) * (v - v∞(x, z, t)) / p.τ
@inline sponge_w(x, y, z, t, w, p) = -(south_mask(x, y, z, p)) * w / p.τ
