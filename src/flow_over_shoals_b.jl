...
# simulation knobs
run_number = 100 # <-- change this for each new run
sim_runtime = 20days
callback_interval = 86400seconds
run_tag = "bdd_shoals$(run_number)"

if LES
    params = (; Lx=100e3, Ly=200e3, Lz=50, Nx=50, Ny=100, Nz=10)
else
    params = (; Lx=100000, Ly=200000, Lz=50, Nx=50, Ny=100, Nz=10)
end
if arch == CPU()
...
set!(model, v=(x,y,z) -> v∞(x,z,0,params), T=Tᵢ, S=Sᵢ)
